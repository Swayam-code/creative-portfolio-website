  ...
  return (
    <footer className="c-space pt-7 pb-3 border-t border-black-300 flex justify-between items-center flex-wrap gap-5">
      ...
      <div className="flex gap-3">
        <a href="https://github.com/Swayam-code" target="_blank" rel="noopener noreferrer" className="social-icon">
      ...
      <p className="text-white-500"> 2024 Swayam Prakash Kar. All rights reserved.</p>
    </footer>
  );
};
